...
export default function LoginPage() {
  const [email, setEmail] = useState('demo@estudos.local');
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center px-8 sm:px-16 md:px-24 xl:px-32 relative">
        ...
        <div className="max-w-sm w-full mx-auto animate-fade-in mt-12">
          ...
          <p className="text-neutral-500 mt-2 mb-8 text-sm">
            Bem-vindo de volta! Faça login para continuar sua jornada de aprendizado.
          </p>
          ...
          <div className="mt-8 text-center text-sm text-neutral-500">
            ...
            <Link to="/register" className="text-brand-600 font-medium hover:text-brand-800 hover:underline transition-colors">
        ...
        <div className="max-w-md w-full animate-slide-up">
          <div className="space-y-6">
            ...
            <div className="pt-2">
              ...
              <p className="text-neutral-500 text-sm mt-1">Transforme seu potencial em sabedoria.</p>
            </div>
          </div>
        </div>
      </div>
